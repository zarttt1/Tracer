...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (mysqli_num_rows($check_bentrok) > 0) {
        ...
        // Query INSERT Standar (Tanpa kolom lokasi)
        $sql = "INSERT INTO bookings (room_id, nama_peminjam, bu, subject, tanggal, layout, meals, catatan, status, waktu) 
                VALUES ('$room_id', '$nama', '$bu', '$subject', '$tanggal', '$layout', '$meals', '$catatan', 'pending', '$sesi_pilihan')";
...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: "Inter", sans-serif; }
        ...
        .nav-links a { color: rgba(255, 255, 255, 0.7); text-decoration: none; padding: 8px 16px; border-radius: 8px; font-weight: 600; font-size: 14px; }
        ...
        input, select { width: 100%; padding: 12px 16px; border: 1.5px solid var(--border); border-radius: 10px; font-size: 14px; background: #fcfcfd; }
